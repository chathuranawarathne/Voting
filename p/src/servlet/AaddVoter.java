...
/**
 * Servlet implementation class AaddVoter
 */
public class AaddVoter extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String re ="voter registered successfully";
			request.setAttribute("Success", re);
			RequestDispatcher  rd = request.getRequestDispatcher("/Aaddvoter.jsp");
