...
<div style="margin-left:200px;margin-right:100px ;margin-top:-100px;margin-bottom:200px;">
	...
	<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Delete Parties</h4>
	<div style="height:150px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="AdeleteParty" style="border-style: groove;height:100px;width:300px" align="center" method="POST">
		
			<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Enter Party ID/name</h4>
			<hr>
  			<input list="browsers" name="Party">
	 ...
	 String sql1 = "select * from parties";
  ...
  <h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">${delete}<h4>
	...
	<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Search parties</h4>
	<div style="height:120px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="AsearchParty" style="border-style: groove;height:100px;width:300px" align="center" method="POST">
		
			<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Enter  PID</h4>
			<hr>
  			<input list="browsers" name="party">
  			<datalist id="browsers">
  			<% 
  ...
  <input type="submit" value="search voter">
  <h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">${search}<h4>
	 ...
	 <hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Update party</h4>
	<div style="height:120px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="AupdateParty" style="border-style: groove;height:100px;width:600px" align="center" method="POST">
		
			
			<h5 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">select  options</h5>
			<hr>
  			<input list="browsers" name="partyid">
  			<datalist id="browsers">
  			<% 
	...
	%>
 	...
 	<select name="clm">
 	 	<option value="pid">Party ID</option>
