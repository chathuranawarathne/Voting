...
<div style="margin-left:200px;margin-right:100px ;margin-top:-100px;margin-bottom:150px;">

		<form action="AaddParties" style="border:1px solid #ccc" name="myforms" onsubmit="return fromvalidate()" method="post">
  <div style="  padding: 56px ; margin-bottom" class="container" >
  
  <h2 align="center">Signup Form for party </h2>
    ...
    box-sizing: border-box;" type="text" placeholder="Enter name" name="fname" required onclick=>
