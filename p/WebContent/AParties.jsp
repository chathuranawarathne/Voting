...
<div style="margin-left:300px;margin-right:100px ;margin-top:00px;margin-bottom:0px;">
	<div style="margin-left:200px ;margin-bottom:70px">
		<form action="/action_page.php">
		
 			Add Parties    :<input type="submit" value="Select">
		</form> 
	</div>
	<div style="margin-left:200px;margin-bottom:70px">
		 <form action="/action_page.php">
 			Delete Parties :<input type="submit" value="Select">
		</form> 
	</div>
	<div style="margin-left:200px;margin-bottom:70px">
		<form action="/action_page.php">
