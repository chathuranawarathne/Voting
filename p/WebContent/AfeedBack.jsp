...
<div style="margin-left:200px;margin-right:100px ;margin-top:-100px;margin-bottom:0px;">
	...
	<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Delete Feedback</h4>
	<div style="height:150px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="Adeletefeedback" style="border-style: groove;height:100px;width:300px" align="center" method="POST">
		
			<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Enter Feedback ID</h4>
			<hr>
  			<input list="browsers" name="Feedback">
