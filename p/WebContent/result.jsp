...
<body>
	...
	<div style="margin-left:120px;margin-right:120px ;margin-top:100px;">
	
	
	<form action="viewresult" method="POST">
  			<input type="submit" value="Click here to view result">
	</form> 
	
	 <h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">${Name}<h4>
