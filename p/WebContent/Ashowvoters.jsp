...
<div style="margin-left:200px;margin-right:100px ;margin-top:-100px;margin-bottom:200px;">
	...
	<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Delete voters</h4>
	<div style="height:150px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="deleteVoter" style="border-style: groove;height:100px;width:300px" align="center" method="POST">
		
			<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Enter voter ID/name</h4>
			<hr>
  ...
  <h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">${delete}<h4>
	...
	<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Search voters</h4>
	<div style="height:120px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="Asearchvoter" style="border-style: groove;height:100px;width:300px" align="center" method="POST">
		
			<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Enter voter ID</h4>
			<hr>
  			<input list="browsers" name="voter">
  			<datalist id="browsers">
  			<% 
  ...
  <h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">${search}<h4>
		...
		<tr>
 		...
 		<hr>
	<h4 style="font-family: Trebuchet MS", Arial, Helvetica, sans-serif;">Update voter</h4>
	<div style="height:120px; width:400px; margin-top:20px; margin-left:20px;">
	
		<form action="AupdateVoter" style="border-style: groove;height:100px;width:600px" align="center" method="POST">
	...
	%>
 	...
 	<select name="clm">
 	 	...
 	 	<option value="Tnumber">Mobile number</option>
